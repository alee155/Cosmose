...
class InterestingArticlesDetails extends StatefulWidget {
  final InterestingArticle post;

  const InterestingArticlesDetails({super.key, required this.post});

  @override
  State<InterestingArticlesDetails> createState() =>
      _InterestingArticlesDetailsState();
}

class _InterestingArticlesDetailsState
    extends State<InterestingArticlesDetails> {
